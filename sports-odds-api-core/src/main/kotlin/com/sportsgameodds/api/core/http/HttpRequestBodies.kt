...
import com.sportsgameodds.api.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw SportsGameOddsInvalidDataException(
        ...
        JsonNodeType.POJO,
        null ->
            throw SportsGameOddsInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
