...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LeagueGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LeagueGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LeagueGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(leagueGetParams: LeagueGetParams) = apply {
            leagueId = leagueGetParams.leagueId
            sportId = leagueGetParams.sportId
            additionalHeaders = leagueGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = leagueGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LeagueGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LeagueGetParams =
            LeagueGetParams(
                leagueId,
                sportId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LeagueGetParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(leagueId, sportId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "LeagueGetParams{leagueId=$leagueId, sportId=$sportId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
