...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.sportsgameodds.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.sportsgameodds.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.sportsgameodds.api.** {
    <init>(...);
