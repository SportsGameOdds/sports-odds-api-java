...
/**
 * A client for interacting with the Sports Game Odds REST API asynchronously. You can also switch
 ...
 * may call [close].
 */
interface SportsGameOddsClientAsync {
    ...
    /**
     * A view of [SportsGameOddsClientAsync] that provides access to raw HTTP responses for each
     * method.
     */
