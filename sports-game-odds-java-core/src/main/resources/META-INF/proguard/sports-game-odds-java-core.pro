...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.sports_odds_api.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.sports_odds_api.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.sports_odds_api.api.** {
    <init>(...);
