...
import com.sports_odds_api.api.core.http.HttpRequestBody
import com.sports_odds_api.api.core.http.HttpResponse
import com.sports_odds_api.api.errors.SportsGameOddsIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw SportsGameOddsIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
            ...
            .enqueue(
                object : Callback {
                    ...
                    override fun onFailure(call: Call, e: IOException) {
                        future.completeExceptionally(SportsGameOddsIoException("Request failed", e))
                    }
                }
            )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("SPORTS_GAME_ODDS_LOG")?.lowercase()) {
